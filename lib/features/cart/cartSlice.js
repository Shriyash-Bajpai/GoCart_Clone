...
export const uploadCart=createAsyncThunk('cart/uploadCart',
    async({getToken},thunkAPI)=>{
        try{
            ...
            },1000);                                                        // API call after every 1s(1000ms) in case of quick inc in size of cart, thus preventing extra unnecassary calls to server
            // return {message:"Cart updated successfully"};
        }catch(error){
            console.log("Error in cart slice");
            console.log(error);
